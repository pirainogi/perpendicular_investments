...
class InvestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post investors_url, params: { investor: { dob: @investor.dob, first_name: @investor.first_name, last_name: @investor.last_name, phone: @investor.phone, state_address: @investor.state_address, street_address: @investor.street_address, zip_code: @investor.zip_code } }
    end
  ...
  test "should update investor" do
    patch investor_url(@investor), params: { investor: { dob: @investor.dob, first_name: @investor.first_name, last_name: @investor.last_name, phone: @investor.phone, state_address: @investor.state_address, street_address: @investor.street_address, zip_code: @investor.zip_code } }
